...
internal object UniffiLib {
    ...
    external fun uniffi_mob_fn_method_client_execute_contract(`ptr`: Long,`contractAddress`: RustBuffer.ByValue,`msg`: RustBuffer.ByValue,`funds`: RustBuffer.ByValue,`memo`: RustBuffer.ByValue,uniffi_out_err: UniffiRustCallStatus, 
    ): RustBuffer.ByValue
...
private fun uniffiCheckApiChecksums(lib: IntegrityCheckingUniffiLib) {
    ...
    if (lib.uniffi_mob_checksum_method_client_execute_contract() != 63353.toShort()) {
        throw RuntimeException("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    }
...
public interface ClientInterface {
     ...
     */
    fun `executeContract`(`contractAddress`: kotlin.String, `msg`: kotlin.ByteArray, `funds`: List<Coin>, `memo`: kotlin.String?): TxResponse
...
open class Client: Disposable, AutoCloseable, ClientInterface
{
     ...
     * Execute a CosmWasm contract (synchronous wrapper)
     */
    @Throws(MobException::class)override fun `executeContract`(`contractAddress`: kotlin.String, `msg`: kotlin.ByteArray, `funds`: List<Coin>, `memo`: kotlin.String?): TxResponse {
            return FfiConverterTypeTxResponse.lift(
    callWithHandle {
    uniffiRustCallWithError(MobException) { _status ->
    UniffiLib.uniffi_mob_fn_method_client_execute_contract(
        it,
        FfiConverterString.lower(`contractAddress`),FfiConverterByteArray.lower(`msg`),FfiConverterSequenceTypeCoin.lower(`funds`),FfiConverterOptionalString.lower(`memo`),_status)
}
    }
    )
    }
